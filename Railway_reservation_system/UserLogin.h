...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(102, 90);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(390, 164);
			this->groupBox1->TabIndex = 0;
			this->groupBox1->TabStop = false;
			this->groupBox1->Text = L"Login As User";
			// 
			// textBox2
			// 
			this->textBox2->BackColor = System::Drawing::SystemColors::MenuBar;
			this->textBox2->Location = System::Drawing::Point(194, 105);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(175, 34);
			...
			this->textBox1->Location = System::Drawing::Point(194, 47);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(175, 34);
			this->textBox1->TabIndex = 2;
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Font = (gcnew System::Drawing::Font(L"Century Schoolbook", 11.89565F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Century Schoolbook", 11.89565F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->button1->Location = System::Drawing::Point(307, 260);
			...
			this->button2->Location = System::Drawing::Point(190, 260);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(111, 45);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	MySqlCommand^ cmdDataBase = gcnew MySqlCommand("select * from databaserailway.userinfo where username='"+ this->textBox1->Text +"' and password='" + this->textBox2->Text + "';", conDataBase);
	...
	try
	{
		...
		if (count == 1) {
			...
			UserInterface^ access =gcnew UserInterface(textBox1->Text);
			this->Hide();
			access->ShowDialog();
		}
		else {
